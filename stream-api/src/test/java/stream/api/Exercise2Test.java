...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void descSortByAge() {
         ...
         */
        Comparator<Integer> descOrder = (i1, i2) -> i2.compareTo(i1);
    ...
    public void top3RichCustomer() {
         ...
         */
        Comparator<? super Customer> compareWealth = (c1, c2) -> c2.getBudget().compareTo(c1.getBudget());
        Stream<String> top3RichCustomerStream =
                customerList.stream()
                        .sorted(compareWealth)
                        .limit(3)
    ...
    public void itemsCustomersWantToBuy() {
        ...
        Stream<String> itemStream = customerList.stream().map(getItemStream).flatMap(is -> is.map(Item::getName));
