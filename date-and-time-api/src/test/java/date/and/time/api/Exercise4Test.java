...
public class Exercise4Test {
    ...
    public void zonedDateTimeFormat() {
         ...
         */
        String strZdt = zdt.format(DateTimeFormatter.ofPattern("YYYY_MM_dd_HH_mm_ss_zzz"));
    ...
    public void toPST() {
         ...
         */
        ZonedDateTime zonedDateTime = ZonedDateTime.of(ldt, ZoneId.of("America/Los_Angeles"));
